    ...
    <div>
        ...
        <section class="data_section" style="width:100%;">
            ...
            <el-row :gutter="20" style="margin-bottom: 10px; display:flex">
                ...
                <el-col :span="4"><div class="data_list " style="width:143px;margin-left:310%;}"><span class="data_num">{{orderCount}}</span> 新增订单</div></el-col>
            </el-row>
            <el-row :gutter="20">
                <el-col :span="4"><div class="data_list all_head" style="width:143px;margin-left:40%;"><span class="data_num head">总数据：</span></div></el-col>
                <el-col :span="4"><div class="data_list" style="width:143px;margin-left:310%;"><span class="data_num">{{allOrderCount}}</span> 订单</div></el-col>
            </el-row>
        </section>
